...
// Bac de production du labo Héroïne. Script séparé et dédié (ne touche pas à LabSlot,
...
public class HeroinLabSlot : MonoBehaviour, IDropHandler, IPointerClickHandler
{
    [System.Serializable]
    ...
    public HeroinLabManager manager;
